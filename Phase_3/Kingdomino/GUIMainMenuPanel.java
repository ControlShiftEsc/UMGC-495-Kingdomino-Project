 ...
 * @File: GUIMainMenuPanel.java
 * @Description: This class contains the main menu panel in the pre-game option menu
 * 
 */
...
public class GUIMainMenuPanel extends JPanel {
	...
	public GUIMainMenuPanel() {
		...
		JLabel pageTitle = new JLabel("Main Menu");
		...
		String[] buttonText = new String[] { "Play Game", "How to Play", "Credits", "Exit Game" };
		 ...
		 * super.componentResized(e); int width = getWidth(); int height = getHeight();
		 * 
		 * pageTitle.setPreferredSize( new Dimension((int) (0.3472222 * width), (int)
		 * (0.07716049 * height))); pageTitle.setMinimumSize( new Dimension((int)
		 * (0.3472222 * width), (int) (0.07716049 * height))); pageTitle.setFont(new
		 * Font("Augusta", Font.PLAIN, (int) (width * 0.05208333)));
		 * 
		 * for (JButton b : buttonList) { b.setSize(new Dimension((int) (width *
		 * 0.260416666), (int) (height * 0.1157407))); b.setFont(new Font("Augusta",
		 * Font.PLAIN, (int) (width * 0.04))); Image newButtonImage = ((ImageIcon)
		 * b.getIcon()).getImage().getScaledInstance( b.getWidth(), b.getHeight(),
		 * Image.SCALE_SMOOTH); b.setIcon(new ImageIcon(newButtonImage)); }
		 * 
		 * } });
		 */
	}
	...
	protected void paintComponent(Graphics g) {
		...
		/*
		Image newImage = GUIImageController.getBackGroundImage(3).getScaledInstance(this.getWidth(), this.getHeight(),
				Image.SCALE_SMOOTH);
	...
	private class TitleMenuListenerClicked extends MouseAdapter {
		...
		public void mousePressed(MouseEvent e) {
			...
			if (e.getSource() == buttonList.get(0)) {
				...
				GUIComponentController.getCardLayout().show(GUIComponentController.getParentPanel(), "rulesCard");
