 ...
 * @Description: The panel display for inputting player names before the game starts
 */
...
public class GUIPlayerNamePanel extends JPanel{
        ...
        public void mousePressed(MouseEvent e) {
    		SwingUtilities.invokeLater(new Runnable() {
    			public void run() {
    				...
    				((GUIGamePlayPanel)GUIComponentController.getComponentList().get(6)).initialize();
    				GUIComponentController.getOptionButton().setVisible(true);
    			}
    		});
    	}
	};
	...
	public void updateLayout() {
        ...
        pageTitle.setPreferredSize(new Dimension(
        		GUIResolutionController.convertScaleWidth(2400), GUIResolutionController.convertScaleHeight(300))); 
        // set the size
        ...
        c.gridwidth = 1;
        c.ipady = 0;
        c.ipadx = GUIResolutionController.convertScaleWidth(60);
		c.insets = new Insets(0, 0, 0, 0);
		c.gridx = 1; // set element to be placed at gridx location 0
		c.fill = GridBagConstraints.NONE; // make element to be placed fill horizontal space
		...
		// 20 pixel space at top between elements
